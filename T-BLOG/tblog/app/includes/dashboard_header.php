<header>
    ...
    <ul class="nav">
        ...
        <li><a href="<?php echo BASE_URL . '/tblog_search.php?u_id=' . $_SESSION['id'] . '&name=' . $_SESSION['username'] ?>">Mio Blog</a></li>
        <li><a href="#"><i class="fa fa-user"></i> <?php echo $_SESSION['username']; ?> <i class="fa fa-chevron-down" style="font-size: .8em;"></i></a>
            <ul>
